...
public class ParkingManagerTest {
    ...
    public void whenGivenCars_WhenWhite_ShouldReturnListOfCarLocation() {
        ...
        PoliceStation policeStation = mock(PoliceStation.class);
        policeStation.addManager(parkingManager);
        when(policeStation.getCar(Vehicle.COLOR.WHITE)).thenReturn(parkingManager.getCarLocationByColor(Vehicle.COLOR.WHITE));
    ...
    public void whenGivenCars_WhenToyotaBlue_ShouldReturnListOfCarLocation() {
        ...
        PoliceStation policeStation = mock(PoliceStation.class);
        policeStation.addManager(parkingManager);
        when(policeStation.getCar(Vehicle.COLOR.BLUE, TOYOTA)).thenReturn(parkingManager.getCarByMakeAndColor(Vehicle.COLOR.BLUE,TOYOTA));
    ...
    public void whenGivenCars_WhenBMW_ShouldReturnListOfCarLocation() {
        ...
        PoliceStation policeStation = mock(PoliceStation.class);
        policeStation.addManager(parkingManager);
        when(policeStation.getCar(BMW)).thenReturn(parkingManager.getCarByMaker(BMW));
    ...
    public void givenCars_WhenTime_ShouldReturnCar() throws InterruptedException {
        ...
        PoliceStation policeStation = mock(PoliceStation.class);
        policeStation.addManager(parkingManager);
        when(policeStation.getCar(3000)).thenReturn(parkingManager.getCarByTime(3000));
    ...
    public void givenHandicappedCars_WhenBandDrow_ShouldReturnCars() {
        ...
        PoliceStation policeStation = mock(PoliceStation.class);
        policeStation.addManager(parkingManager);
        when(policeStation.getCar("BD",true)).thenReturn(parkingManager.getCarByRowAndHandicapped("BD"));
    ...
    public void givenCars_WhenAllCars_ReturnAllCars() {
        ...
        PoliceStation policeStation = mock(PoliceStation.class);
        policeStation.addManager(parkingManager);
        when(policeStation.getCar()).thenReturn(parkingManager.getAllCars());
